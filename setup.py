...
# Package meta-data.
NAME = "balderdash"
DESCRIPTION = "A tool for authoring Dash apps as Markdown documents"

# These can be set to None if you want to omit them
URL = "https://github.com/ned2/balderdash"
AUTHOR = "Ned Letcher"
...
setup(
    ...
    scripts=[],
    entry_points={"console_scripts": ["bdash=balderdash.cli:main"]},
)
